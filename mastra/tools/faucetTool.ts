...
export const faucetTool = createTool({
  id: "faucetTool",
  description: "Suggest the /faucet command for the user to receive 1 HBAR test token.",
  ...
  execute: async ({ context }) => {
    ...
    const message = username
      ? `To receive 1 HBAR, tap and send: \`${suggested}\``
      : `To receive 1 HBAR, type or tap: \`${suggested}\``;
